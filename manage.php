                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    <?php foreach ($departments as $dept): ?>
                                        <?php
                                        $deptId = $dept['id'] ?? 0;
                                        $moduleCount = count(array_filter($allModules, fn($m) => $m['department_id'] == $deptId));
                                        $categoryCount = count(array_filter($allCategories, fn($c) => $c['department_id'] == $deptId));
                                        ?>
                                        <tr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless table-sm">
                            ...
                            <tr>
                                ...
                                <td><code><?php echo realpath($uploadPath) ?: $uploadPath; ?></code></td>
                            </tr>
                            <tr>
                                <td>Directory Writable:</td>
                                <td>
                                    <?php if (is_dir($uploadPath) && is_writable($uploadPath)): ?>
                                        <span class="badge bg-success">Yes</span>
                                    <?php elseif (!is_dir($uploadPath)): ?>
                                        <span class="badge bg-warning">Directory Missing</span>
                                    <?php else: ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless table-sm">
                            ...
                            <tr>
                                <td>Version:</td>
                                <td><?php echo $pdo->query("SELECT sqlite_version()")->fetchColumn(); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
